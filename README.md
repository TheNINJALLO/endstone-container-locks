...
A container locking system for Minecraft Bedrock servers using Endstone. This release is aligned with Endstone 0.11.9 and Minecraft Bedrock Dedicated Server 1.26.44, and is distributed as a Python wheel for direct installation in an Endstone server.
...
```bash
gh release download v1.4.2 --repo TheNINJALLO/endstone-container-locks --pattern "*.whl"
```
...
Built for Endstone 0.11.9+ with Python 3.10+
